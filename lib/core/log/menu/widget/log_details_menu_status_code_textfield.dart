...
class LogDetailsMenuStatusCodeTextField extends ConsumerWidget {
  const LogDetailsMenuStatusCodeTextField({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final logDetailsMenuState = ref.watch(LogProvider.logDetailsMenuControllerProvider);

    if (logDetailsMenuState.statusCode == null) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        AdvancedTextField(
          ...
          focusNode: FocusNode(),
          textEditingController: TextEditingController(text: logDetailsMenuState.statusCode.toString()),
          maxLines: null,
