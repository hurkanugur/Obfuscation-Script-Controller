...
class LogDetailsMenuMethodNameTextField extends ConsumerWidget {
  const LogDetailsMenuMethodNameTextField({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final logDetailsMenuState = ref.watch(LogProvider.logDetailsMenuControllerProvider);

    if (logDetailsMenuState.methodName == null || logDetailsMenuState.methodName!.isEmpty) {
    ...
    return Column(
      ...
      children: <Widget>[
        Text(
          ref.translateText(textType: TextType.methodName),
        ...
        AdvancedTextField(
          ...
          focusNode: FocusNode(),
          textEditingController: TextEditingController(text: logDetailsMenuState.methodName),
          maxLines: null,
