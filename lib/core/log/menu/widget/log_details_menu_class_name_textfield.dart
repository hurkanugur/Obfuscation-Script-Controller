...
class LogDetailsMenuClassNameTextField extends ConsumerWidget {
  const LogDetailsMenuClassNameTextField({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final logDetailsMenuState = ref.watch(LogProvider.logDetailsMenuControllerProvider);

    if (logDetailsMenuState.className == null || logDetailsMenuState.className!.isEmpty) {
    ...
    return Column(
      ...
      children: <Widget>[
        Text(
          ref.translateText(textType: TextType.className),
        ...
        AdvancedTextField(
          ...
          focusNode: FocusNode(),
          textEditingController: TextEditingController(text: logDetailsMenuState.className),
          maxLines: null,
