...
class LogDetailsMenuExceptionMessageTextField extends ConsumerWidget {
  const LogDetailsMenuExceptionMessageTextField({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final logDetailsMenuState = ref.watch(LogProvider.logDetailsMenuControllerProvider);

    if (logDetailsMenuState.exceptionMessage == null || logDetailsMenuState.exceptionMessage!.isEmpty) {
    ...
    return Column(
      ...
      children: <Widget>[
        Text(
          ref.translateText(textType: TextType.exceptionMessage),
        ...
        AdvancedTextField(
          ...
          focusNode: FocusNode(),
          textEditingController: TextEditingController(text: logDetailsMenuState.exceptionMessage),
          maxLines: null,
