...
class AdvancedBorderModel extends Equatable {
  ...
  BorderRadius getBorderRadius({required BuildContext context}) {
    return BorderRadius.only(
      topLeft: isTopLeftRounded ? Radius.circular(AppDimensions.widgetRadius) : Radius.zero,
      topRight: isTopRightRounded ? Radius.circular(AppDimensions.widgetRadius) : Radius.zero,
      bottomLeft: isBottomLeftRounded ? Radius.circular(AppDimensions.widgetRadius) : Radius.zero,
      bottomRight: isBottomRightRounded ? Radius.circular(AppDimensions.widgetRadius) : Radius.zero,
    );
  }
}
