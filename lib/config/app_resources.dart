class AppResources {
  ...
  /// https://lottiefiles.com/animations/loading-e2j1A8oi6J?from=search
  static const String lottieLoadingAnimationPath = 'assets/lottie/loading_animation.json';

  /// https://lottiefiles.com/91517-hello
  static const String lottieLaunchScreenAnimationPath = 'assets/lottie/launch_screen_animation.json';
